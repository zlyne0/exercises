...
public class ExampleEurekaClient {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("applications " + client.getApplications().getRegisteredApplications());
        System.out.println("client.getInstanceRemoteStatus() " + client.getInstanceRemoteStatus());
        List<InstanceInfo> instancesByVipAddress = client.getInstancesByVipAddress("echoClient2", false);
        System.out.println("instancesByVipAddress " + instancesByVipAddress);
